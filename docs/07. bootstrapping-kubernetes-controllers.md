...
```
wget \
  "https://storage.googleapis.com/kubernetes-release/release/v1.19.6/bin/linux/amd64/kube-apiserver" \
  "https://storage.googleapis.com/kubernetes-release/release/v1.19.6/bin/linux/amd64/kube-controller-manager" \
  "https://storage.googleapis.com/kubernetes-release/release/v1.19.6/bin/linux/amd64/kube-scheduler" \
...
이 과정은 Controller node 1개에서만 진행하면 됩니다.
...
NEXT: https://github.com/Dante-in-Korea/kuberenetes-hardway-only-ec2/blob/main/docs/08.%20bootstrapping-kubernetes-haproxy.md
